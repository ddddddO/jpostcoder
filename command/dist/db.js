...
exports.createPostcodes = exports.dropPostcodes = exports.insertJpostcodes = void 0;
...
const createPostcodes = (db) => {
    db.prepare(`create table postcodes(
...
exports.createPostcodes = createPostcodes;
